    ...
    xhr.onload = function() {
        if (xhr.status === 200) {
            ...
            for (var i = 0; i < data.length; i++) {
                html += `<div class="panel panel-info"><div class="panel-heading"><h3> ${data[i].itemCode} - ${data[i].name}</h3><div class="clearfix"></div></div><div class="panel-body"><p id=tweets> ${data[i].description}</p><div class='well'>Price : ${data[i].price}
              Stock : ${data[i].stock}</div></div></div>`
            }
...
function loadTableCustomer() {
    ...
    xhr.onload = function() {
        if (xhr.status === 200) {
            ...
            for (var i = 0; i < data.length; i++) {
                html += `<div class="panel panel-info"><div class="panel-heading"><h3> ${data[i].memberId} - ${data[i].name}</h3><div class="clearfix"></div></div><div class="panel-body"><div class='well'> Address : ${data[i].address}</div><div class='well'>ZIP : ${data[i].zip}</div>
              <div class='well'>Phone : ${data[i].phone}</div></div></div>`
            }
